...
#new varialbles for vertical histogram
pH = ""
tH = ""
rH = ""
eH = ""
loopConditionTwo = True#variable for loop to run the amount of times of outcome(s)
finalOutcomeCount = outcomeCount#new variable for storing the amount of outcomes as i am using the outcomeCount variable in the loop below

print('''
Progress   Trailer    Retriever  Excluded''')#multiline to look neater
                   
                
while loopConditionTwo is True :
    
    if progressCount == 0 :#print a set amount of empty spaces if no result
        pH = "           "
    elif progressCount > 0 :
        pH = "     *     "#print asterisk for histogram in the middle instead of a space
        progressCount -= 1
        outcomeCount -= 1
    ...
    if outcomeCount <= 0 :#once all the outcomes are over it will stop printing as the histogram is over
        break
print(finalOutcomeCount,"outcomes in total")#using the new variable that stored the value of outcomes
